...
import './HeroNavSeguridadIntegral.css';
...
const HeroNavSeguridadIntegral = () => {
          ...
          <div className="hn__dropdown">
            ...
            <div className="hn__dropdown-panel">
              ...
              {serviceLinks.map((service, i) => (
                ...
                >
                  {service.icon && <FontAwesomeIcon icon={service.icon} className="hn__dropdown-item-icon" />}
            ...
            >
              {serviceLinks.map((service, i) => (
                <button
                  ...
                  onClick={() => navigateTo(service.path)}
                >
                  {service.icon && <FontAwesomeIcon icon={service.icon} className="hn__sub-link-icon" />}
                  <span>{service.name}</span>
                </button>
              ))}
            </div>
...
export default HeroNavSeguridadIntegral;