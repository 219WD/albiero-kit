...
const HeroNavGps = () => {
  ...
  // Links de navegación específicos de GPS CON ICONOS
  const navLinks = [
    ...
    <nav className="hn">
      <div className="hn__container">
        ...
        <div className="hn__links">
          ...
          {/* Links específicos de GPS con iconos */}
      ...
      <div className={`hn__mobile${mobileMenuOpen ? ' open' : ''}`} aria-hidden={!mobileMenuOpen}>
        ...
        <div className="hn__mobile-links">
          ...
          {/* Links específicos de GPS en móvil */}
          {navLinks.map((link, index) => (
            <button
              key={index}
