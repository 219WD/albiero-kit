// ExpertiseAreasAlarmas.jsx
import React, { useState, useRef, useEffect } from "react";
import "./ExpertiseAreasAlarmas.css";
  ...
  const expertiseData = [
    {
      ...
      description:
        "Dormí tranquilo sabiendo que tu hogar está protegido. El sistema detecta movimientos o accesos no autorizados y envía la señal inmediatamente a nuestra central.",
      detailsLabel: "Beneficios:",
      details: [
    ...
    },
    {
      ...
      description:
        "Protegé tu negocio incluso cuando está cerrado. El sistema permite detectar intrusiones y activar protocolos de seguridad inmediatamente.",
      detailsLabel: "Ideal para:",
      details: [
        "Proteger mercadería",
        "Evitar robos fuera de horario",
        "Mantener monitoreo nocturno",
        "Tener control permanente del local",
      ],
      image: comercial,
    },
  ];
...
export default ExpertiseAreasAlarmas;