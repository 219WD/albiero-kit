// ExpertiseAreasIncendio.jsx
import React, { useState, useRef, useEffect } from "react";
import "./ExpertiseAreasIncendio.css";
  ...
  const expertiseData = [
    {
      ...
      description:
        "Protegé tu hogar frente a riesgos invisibles. Los sensores detectan humo, gas o calor anormal y alertan de forma inmediata, incluso mientras dormís.",
      detailsLabel: "Ideal para:",
      details: [
        "Prevención de incendios eléctricos",
        "Detección de fugas de gas",
        "Alerta temprana mientras dormís",
        "Protección cuando no estás",
      ],
      image: casa,
    },
    {
      ...
      description:
        "Reducí riesgos operativos y protegé tu inversión. Un sistema de detección temprana puede evitar pérdidas materiales y garantizar la continuidad de tu negocio.",
      detailsLabel: "Ideal para:",
      details: [
        "Depósitos y mercadería",
        "Cocinas industriales",
        "Instalaciones eléctricas",
        "Prevención fuera de horario comercial",
      ],
      image: comercial,
    },
  ];
...
export default ExpertiseAreasIncendio;