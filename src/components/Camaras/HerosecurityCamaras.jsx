...
const HerosecurityCamaras = () => {
  ...
  const handleSubmit = (selectedData = formData) => {
    ...
    const mensaje = `Hola! Quiero asesoramiento por el sistema de cámaras de seguridad.%0A%0A📋 *Mi consulta:*%0A• Para: ${tipoTexto}%0A• Ubicación: ${selectedData.ubicacion}%0A• Sistema: ${sistemaTexto}%0A%0AQuiero recibir información sin compromiso.`;
