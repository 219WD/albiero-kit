// RespaldoAlbieroCamaras.jsx
import React, { useState } from "react";
import "./RespaldoAlbieroCamaras.css";
  ...
  const albieroFeatures = [
    {
      ...
      description:
        "Instalaciones realizadas por técnicos especializados con años de experiencia en el campo.",
    },
    {
      id: 2,
      icon: faMicrochip,
      ...
      description:
        "Equipos confiables y configuraciones profesionales para que el sistema funcione correctamente desde el primer día.",
    },
    {
      id: 3,
        ...
        <div className="albiero-content">
          ...
          <div className="albiero-left">
            ...
            <p className="albiero-quote">
              <span className="albiero-quote-line">
                La diferencia no es solo ver.
              </span>
              <br />
              <span className="albiero-quote-highlight">
                La diferencia es tener control.
              </span>
            </p>
          ...
          <div className="albiero-right">
            <div className="albiero-image-container">
              <img
                src={central}
                alt="Albiero Seguridad - Instalación profesional de cámaras"
                width="665"
                height="998"
...
export default RespaldoAlbieroCamaras;